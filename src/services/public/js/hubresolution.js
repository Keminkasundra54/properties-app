...
`
  ...
  data.forEach(property => {
      ...
      for (let i = 1; i < property.image.length; i++) {
          belowImageString = belowImageString + `
          <div class="prop-imgbox">
                          <div class="prop-img" style="background-image: url(https://propertyapp.hubresolution.com/profile/${property.image[i]});">
                          </div>
                      </div>
          `
      }
      ...
      <div class="prop-rowin">
          <div class="pro-left">
              ...
              ${property.image && property.image.length > 0 ? '<div class="prop-main" style="background-image: url(https://propertyapp.hubresolution.com/profile/'+property.image[0]+');"></div>' : ''}
